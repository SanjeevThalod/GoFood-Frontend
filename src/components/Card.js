        ...
        <div className="card m-3" style={{"width": "18rem",maxHeight:'360px'}}>
            ...
            <div className="card-body">
                ...
                <div className="container ">
                    <select className='m-2 h-100' data-bs-theme='dark' onChange={(e)=>setqty(e.target.value)}>
                    ...
                    <select className='m-2 h-100' data-bs-theme='dark' ref={priceRef} onChange={(e)=>setsize(e.target.value)}>
